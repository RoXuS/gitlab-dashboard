...
(function(exports) {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.json)(url))(function (v2) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Applicative.when(Effect_Aff.applicativeAff)(Data_Eq.notEq(Network_HTTP_StatusCode.eqStatusCode)(v2.status)(200))(Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Failed to fetch projects"))))(function () {
                  var v3 = Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "name";
                  }))(readforeignProjectName)(Simple_JSON.readFieldsNil)()())()())))(Data_Argonaut_Core.stringify(v2.response));
                  if (v3 instanceof Data_Either.Left) {
                  ...
                  throw new Error("Failed pattern match at Gitlab line 147, column 3 - line 150, column 36: " + [ v3.constructor.name ]);
              });
          });
      };
  };
  var genericPipelineStatus = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Gitlab line 33, column 8 - line 33, column 66: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var genericJobeStatus = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Gitlab line 53, column 8 - line 53, column 57: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var readForeignJobStatus = new Simple_JSON.ReadForeign(Foreign_Generic_EnumEncoding.genericDecodeEnum(genericJobeStatus)(Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      ...
      constructorTagTransform: function ($95) {
          return Data_String_CodePoints.drop(3)(Data_String_Common.toLower($95));
      }
  }));
          ...
          return function (project) {
              ...
              var castDates = function (job) {
                  return {
                      ...
                      started_at: Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($96) {
                          return Data_Maybe.Just.create(readJSDate($96));
                      })(job.started_at),
                      finished_at: Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($97) {
                          return Data_Maybe.Just.create(readJSDate($97));
                      })(job.finished_at),
                      commit: job.commit,
                      id: job.id,
                      name: job.name,
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.json)(url))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Applicative.when(Effect_Aff.applicativeAff)(Data_Eq.notEq(Network_HTTP_StatusCode.eqStatusCode)(v2.status)(200))(Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Failed to fetch jobs"))))(function () {
                      var v3 = Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "name";
                      }))(readforeignProjectName)(Simple_JSON.readFieldsNil)()())()())))(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "ref";
                      ...
                      throw new Error("Failed pattern match at Gitlab line 163, column 3 - line 166, column 71: " + [ v3.constructor.name ]);
                  });
              });
          };
      };
